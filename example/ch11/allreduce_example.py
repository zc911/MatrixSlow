...
@LastEditTime: 2020-04-30 16:51:22
...
from matrixslow.trainer import DistTrainerRingAllReduce
...
def train(worker_index):
    ...
    saver = ms.trainer.Saver('./export_allreduce/{}'.format(worker_index))
