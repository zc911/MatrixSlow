...
class ParameterServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.VariableWeightsInit = channel.unary_unary(
        ...
        request_serializer=parameter__server__pb2.VariableWeightsReqResp.SerializeToString,
        response_deserializer=parameter__server__pb2.VariableWeightsReqResp.FromString,
        )
...
def add_ParameterServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'VariableWeightsInit': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=parameter__server__pb2.VariableWeightsReqResp.FromString,
          response_serializer=parameter__server__pb2.VariableWeightsReqResp.SerializeToString,
      ),
